...
"""
    This version is ONLY for adding start time and end time for owhat projects.
    For daily sampling and updating, user other formal versions.
"""
...
def update_owhat():
    ...
    # Force obsolete_project_list to be a null list
    # to update start time and end time
    # for owhat obsoleted projects.
    obsolete_project_list = []
            ...
            for project in projects:
                ...
                # For projects already in table project but not obsoleted, update amount field only.
                    ...
                    try:
                        ...
                        sql = "UPDATE projects SET amount = %s, start_time = %s, end_time = %s, " \
                              "updated_at = %s WHERE project_id = %s"
