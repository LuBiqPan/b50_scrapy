...
def getOwhatRankingList(raiseID, page):
    ...
    for thisItem in rankingList:
        resultList.append(
            rankingModel(thisItem['nickname'], thisItem['number'], thisItem['userid'], thisItem['amount']))
...
def getOwhatSales(raiseID):
    ...
    for thisItem in rankingList:
        resultList.append(
            rankingModel(thisItem['name'], thisItem['price'], thisItem['salestock'], thisItem['remainstock']))
